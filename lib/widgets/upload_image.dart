  ...
  Future<void> segmentImage(BuildContext context) async {
    ...
    try {
      var request = http.MultipartRequest(
          'POST',
          Uri.parse('http://192.168.1.100:5000/segment')); // Change the endpoint to '/segment'
      request.files.add(
      ...
      if (response.statusCode == 200) {
        ...
        final image = Image.memory(bytes, width: double.infinity,
          fit: BoxFit.cover,);
        ...
        AwesomeDialog(
          ...
          animType: AnimType.bottomSlide,
          title: 'Error',
          desc: 'An error occurred while segmenting the image',
